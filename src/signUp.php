...
if ($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    if ($password === $repeat_password){
        ...
        if (isUserAlreadyExist($email)){
            ...
            createUser($salutation, $first_name, $middle_name, $last_name, $dob, $street, $house_number, $zip, $city, $country, $phone, $mobile, $email, $password, $userType, $isActive, $isBlocked);
        }
    }else{
