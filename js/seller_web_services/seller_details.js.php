...
function showSellerSidebar(sellerData){
    ...
    var sWebFormatted = sWeb.replace('https://','');
    sWebFormatted = sWeb.replace('http://','');
...
<div class="p-2">
    ...
    <div class="mx-auto row justify-content-center">
        ...
        <p class="text-secondary ml-2 cst-line-space-contact">${sStreet} ${sBuildingNum}, ${sZip} ${sCity}</p>
    </div>
    ...
    <div class="d-flex flex-column">
        <div class="p-2">
            ...
            <a class=" ml-2 cst-line-space-contact" href="tel:${sPhone}">${sPhone}</a>
        </div>
    ...
    <div class="p-2">
            ...
            <a class="ml-2 cst-line-space-contact" href="mailto:{sEmail}">${sEmail}</a>
    </div>
    ...
    <div class="p-2">
            ...
            <a class="ml-2 cst-line-space-contact" href=${sWeb} target="_blank" rel="noopener noreferrer">${sWebFormatted}</a>
    </div>
</div>
